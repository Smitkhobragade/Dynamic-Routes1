...
export default function Home() {
  return (
    ...
    >        
      ...
      {/* <div className="relative flex place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700/10 after:dark:from-sky-900 after:dark:via-[#0141ff]/40 before:lg:h-[360px] top-36">
        <Image
      ...
      <div className="mb-32 flex text-center lg:mb-0 lg:grid-cols-4 lg:text-left justify-center content-center relative -top-20 gap-6 mt-10 text-white ">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Instantly login your Next.js site.
          </p>
        </Link>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Instantly Move to your profile to your to do list
          </p>
        </Link>
      </div>
    </main>
